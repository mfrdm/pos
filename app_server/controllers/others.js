...
function Others() {
	...
	this.angularApp = function (req, res){
		...
		var serviceFileNames = ['common', 'checkin', 'checkout', 'products','customers', 'assets', 'costs', 'home', 'depts','employees','authentication', 'socket', 'attendance', 'booking', 'other', 'combo', 'order', 'deposit', 'storage', 'promocodes', 'accounts', 'rewards'];
